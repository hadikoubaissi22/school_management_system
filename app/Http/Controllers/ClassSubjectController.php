...
class ClassSubjectController extends Controller
{
    public function list(Request $request)
    {
        ...
        $data['header_title'] = "Subject Assined List";
    ...
    public function add(Request $request)
    {
        ...
        $data['header_title'] = "Add Subject Assined List";
    ...
    public function insert(Request $request)
    {
        ...
        {
            return redirect('admin/assign_subject/list')->with("error","Due to some error pls try again");
        }
    }
    public function edit($id)
    {
        ...
        if(!empty($getRecord))
        {
            ...
            $data['getAssingSubjecID'] = ClassSubjectModel::getAssingSubjecID($getRecord->class_id);
            $data['getClass'] = ClassModel::getClass();
            $data['getSubject'] = SubjectModel::getSubject();
            $data['header_title'] = "Edit Subject Assined";
