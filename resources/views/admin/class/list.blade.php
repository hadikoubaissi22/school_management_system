  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CLass Tables (Total : {{ $getRecord->total() }})</h1>
          </div>
                ...
                <div class="card-body">
                  <div class='row'>
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <a href="{{ url('admin/class/list') }}" class='btn btn-success' type='submit' style='margin-top:30px;'>Clear</a>
                    </div>
                </div>
                </div>
                        ...
                        @foreach ($getRecord as $value)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <a href="{{ url('admin/class/delete/'.$value->id) }}" class='btn btn-danger delete-link'>Delete</a>
                                </td>
                            </tr>
                        @endforeach
                  </tbody>
